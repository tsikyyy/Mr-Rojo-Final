...
class InterventionController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backoffice.interventions.create', compact('voitures', 'types', 'slots', 'statuts'));
    }
    ...
    public function edit(Intervention $intervention)
    {
        ...
        return view('backoffice.interventions.edit', compact('intervention', 'voitures', 'types', 'slots', 'statuts'));
    }
